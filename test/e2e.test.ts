...
test('list and defs reflect created instances', () => {
  ...
  assert.deepEqual(ow('defs').map((d: any) => d.name).sort(), ['delivery', 'full-cycle', 'intake', 'judged-research', 'onboarding', 'provisioned-delivery', 'research', 'routing', 'sla-watchdog']);
